#!/bin/bash
# A U D I O v1.0
# coded by: github.com/kalirootboy/audio
# Twitter: @kalirootboy
...
printf "\e[97m v1.0 coded by github.com/kalirootboy/audio\n\n"

printf "\e[39m                Become a Tux !\n                And froget Windows\n\n"

printf "      \e[5m :: ----------------------------------  ::\e[0m\n"
printf "      \e[31m ::  Warning: Attacking targets without ::\e[0m\n"
printf "      \e[31m ::  prior mutual consent is illegal!   ::\e[0m\n"
printf "      \e[5m :: ----------------------------------- ::\e[0m\n"
printf "\n"
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Audio file saved\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
